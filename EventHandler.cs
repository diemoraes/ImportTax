    ...
    internal static class EventHandler
    {
        ...
        internal static void EventHandlerStart()
        {
          ...
          "OKSFTCD_Update"
            ...
            Support._sboApp.AppEvent += AppEvent;
            Support.pSbo.ItemEvent += ItemEvent;
                ...
                using (StreamReader streamReader = new StreamReader(udfEditValue2))
                {
                    ...
                    while (true)
                    {
                        ...
                        do
                        {
                            ...
                            do
                            {
                                ...
                                switch (num4)
                                {
                                    ...
                                    case 5:
                                        ...
                                        textToSet5 = strArray[5].ToString();
                                    ...
                                    case 7:
                                        ...
                                        textToSet3 = strArray[2].ToString();
                                        textToSet4 = strArray[3].ToString();
                                        Key5 = strArray[4].ToString();
                                        textToSet5 = strArray[5].ToString();
                                        textToSet6 = strArray[6].ToString();
                            ...
                            Console.WriteLine("Valor 5: " + Key5);
                            ...
                            try
                            {
                                ...
                                int num5 = 0;
                                for (int index = 0; index < Support.oMatrix.Columns.Count && num5 < EventHandler.keyFieldsCounter; ++index)
                                {
                                    if (Support.oMatrix.Columns.Item((object)index).Editable)
                                    {
                                        ++num5;
                                        stringList.Add(Support.oMatrix.Columns.Item((object)index).UniqueID);
                                    }
                                }
                                switch (num4)
                                {
                                    ...
                                    case 7:
                                        ...
                                        Support.SetMatrixEditBoxContents(stringList[2], -1, Support.oMatrix.RowCount, textToSet3);
                                        Support.SetMatrixEditBoxContents(stringList[3], -1, Support.oMatrix.RowCount, textToSet4);
                                        Support.SetMatrixEditBoxContents(stringList[4], -1, Support.oMatrix.RowCount, Key5);
                                        break;
                                }
                            }
                            catch (Exception ex)
                            ...
                            if (num3 == 0L)
                            {
                                Support.oMatrix.Columns.Item((object)"2000").Cells.Item((object)Support.oMatrix.RowCount).Click(BoCellClickType.ct_Double, 0);
                                ...
                                for (int index = num4 ; index < length; ++index)
                                {
                                    ...
                                    if (Convert.ToInt32(str3) == 1)
                                    {
                                        if (!string.IsNullOrEmpty(textToSet7))
                                        {
                                            ...
                                            Support.SetMatrixEditBoxContents("256000005", -1, rowIndex, textToSet7);
                                            Support.SetMatrixEditBoxContents("2002", -1, rowIndex, textToSet7);
                                            Support.SetMatrixEditBoxContents("140002005", -1, rowIndex, textToSet7);
                                        }
                                    }
                                    else
                                    {
                                ...
                                activeForm1.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                activeForm1.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                SAPbouiCOM.Form activeForm2 = Support._sboApp.Forms.ActiveForm;
                                activeForm2.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                activeForm2.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                Support._sboApp.Forms.ActiveForm.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                            }
                        }
                        while (num3 != 0L);
        ...
        private static void ItemEvent(string formUid, ref ItemEvent pVal, out bool bubbleEvent)
        {
            ...
            if (pVal.EventType == BoEventTypes.et_FORM_LOAD && (pVal.FormTypeEx == "80402" && pVal.Before_Action))
            {
                try
                {
                    ...
                    formByTypeAndCount.Items.Add("f80402bt1", BoFormItemTypes.it_BUTTON);
                    formByTypeAndCount.Items.Item((object)"f80402bt1").Visible = false;
                    formByTypeAndCount.Items.Add("f80402bt2", BoFormItemTypes.it_BUTTON);
                    formByTypeAndCount.Items.Item((object)"f80402bt2").Visible = false;
                    formByTypeAndCount.Items.Add("f80402bt3", BoFormItemTypes.it_BUTTON);
                    formByTypeAndCount.Items.Item((object)"f80402bt3").Visible = false;
                    ...
                    string recordSetResult5 = EventHandler.Sup.getRecordSetResult(recordSet, 4);
            ...
            if (pVal.EventType == BoEventTypes.et_FORM_VISIBLE && pVal.FormTypeEx == "80402")
            {
                try
                {
                    ...
                    if (!pVal.Before_Action && formByTypeAndCount.Visible)
                    {
                        ...
                        Item tem1 = formByTypeAndCount.Items.Item((object)"f80402bt1");
                        int top1 = formByTypeAndCount.Items.Item((object)"2002").Top;
                        int height1 = formByTypeAndCount.Items.Item((object)"2002").Height;
                        int left1 = formByTypeAndCount.Items.Item((object)"2002").Left;
                        tem1.Left = left1 - 63;
                        tem1.Top = top1;
                        tem1.Width = 60;
                        tem1.Height = height1;
                        tem1.Visible = true;
                        ((IButton)tem1.Specific).Caption = "Importar";
                        Item tem2 = formByTypeAndCount.Items.Item((object)"f80402bt2");
                        int top2 = formByTypeAndCount.Items.Item((object)"2002").Top;
                        int height2 = formByTypeAndCount.Items.Item((object)"2002").Height;
                        int left2 = formByTypeAndCount.Items.Item((object)"2002").Left;
                        tem2.Left = left2 - 126;
                        tem2.Top = top2;
                        tem2.Width = 60;
                        tem2.Height = height2;
                        tem2.Visible = true;
                        ((IButton)tem2.Specific).Caption = "Limpar";
                        Item tem3 = formByTypeAndCount.Items.Item((object)"f80402bt3");
                        int top3 = formByTypeAndCount.Items.Item((object)"2002").Top;
                        int height3 = formByTypeAndCount.Items.Item((object)"2002").Height;
                        int left3 = formByTypeAndCount.Items.Item((object)"2002").Left;
                        tem3.Left = left3 - 189;
                        tem3.Top = top3;
                        tem3.Width = 60;
                        tem3.Height = height3;
                        tem3.Visible = true;
                        ((IButton)tem3.Specific).Caption = "Atualizar";
                ...
                if (pVal.ItemUID == "f80402bt2" && !pVal.Before_Action)
                {
                    try
                    {
                        ...
                        for (int index = Support.oMatrix.RowCount - 1; index > 0; --index)
                        {
                            try
                            {
                                Support.oMatrix.Columns.Item((object)"2000").Cells.Item((object)index).Click(BoCellClickType.ct_Regular, 0);
                            ...
                            {
                                Support.oMatrix.Columns.Item((object)"2000").Cells.Item((object)index).Click(BoCellClickType.ct_Right, 0);
                                Support._sboApp.Menus.Item((object)"1283").Enabled = true;
                                Support._sboApp.Menus.Item((object)"1283").Activate();
                                Support._sboApp.Menus.Item((object)"1283").Enabled = false;
                            }
                    ...
                    while (true)
                    {
                        ...
                        if (num3 == 0)
                        {
                            ...
                            try
                            {
                                ...
                                for (int index = 1; index <= 8; ++index)
                                {
                                    ...
                                    if (num5 >= EventHandler.keyFieldsCounter)
                                        index = 8;
                                    else if (Support.oMatrix.Columns.Item((object)str3).Editable)
                                    {
                                        ++num5;
                                        stringList.Add(str3);
                                    }
                            ...
                            if (num3 == 0)
                            {
                                ...
                                Support.oMatrix.Columns.Item((object)"2000").Cells.Item((object)rowIndex1).Click(BoCellClickType.ct_Double, 0);
                                Support.SetoFormByFormTypeEx("80403");
                                Support.SetoMatrix("2003");
                                int rowIndex2 = 1;
                                ...
                                Support.oMatrix.Columns.Item((object)"2000").Cells.Item((object)rowIndex2).Click(BoCellClickType.ct_Double, 0);
                                int rowIndex3 = 0;
                                for (int index = num4; index < length; ++index)
                                {
                                    ++rowIndex3;
                                ...
                                SAPbouiCOM.Form activeForm1 = Support._sboApp.Forms.ActiveForm;
                                if (((IButton)activeForm1.Items.Item((object)"2000").Specific).Caption.Equals("Atualizar"))
                                {
                                    activeForm1.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                    activeForm1.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                }
                                    ...
                                    activeForm1.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                SAPbouiCOM.Form activeForm2 = Support._sboApp.Forms.ActiveForm;
                                if (((IButton)activeForm2.Items.Item((object)"2000").Specific).Caption.Equals("Atualizar"))
                                {
                                    activeForm2.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                    activeForm2.Items.Item((object)"2000").Click(BoCellClickType.ct_Regular);
                                }
