...
// Type: TaxDeterminationLoader.GetFileNameClass
...
{
  internal class GetFileNameClass
  {
    private readonly OpenFileDialog _oFileDialog = new OpenFileDialog();

    public void GetFileName()
    {
      if (this._oFileDialog.ShowDialog((IWin32Window) new WindowWrapper(GetFileNameClass.GetForegroundWindow())) == DialogResult.OK)
        return;
