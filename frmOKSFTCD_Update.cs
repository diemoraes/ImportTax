  ...
  internal class frmOKSFTCD_Update
  {
    ...
    public frmOKSFTCD_Update()
    {
      try
      {
        ...
        this.oEditSepChar = (EditText) this.oForm.Items.Item((object) "OKSFTCDECS").Specific;
        this.oEditSepChar.DataBind.SetBound(true, "", "OKSFTCDECS");
        this.oEditFilePath = (EditText) this.oForm.Items.Item((object) "OKSFTCDECA").Specific;
